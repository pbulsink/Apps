                            ...
                            dashboardPage(     
                              ...
                              dashboardBody(
                                ...
                                fluidRow(
                                  ...
                                  column(2, selectInput("report", "Report", choices = c("Shots Faced", "On-Ice", "Individual", "Context", "Counts"), selected = "Shots Faced")),
                                ...
                                fluidRow(
                                  ...
                                  column(1),
                                  column(2, tags$div(class = "center-low", downloadButton("dl", "Download File")))
                                ),
                   ...
                   tabPanel("Rolling Average", value = "average",
                            ...
                            dashboardPage(     
                              ...
                              dashboardBody(
                                ...
                                # Input row 1
                                fluidRow(
                                  column(3, dateRangeInput("s1date", "Date Range", min = "2007-10-01", max = Sys.Date(), start = "2015-10-01", end = Sys.Date(), format = "yyyy-mm-dd")),
                                  ...
                                  column(2, selectInput("s1measure", "Measure", choices = c("Sv%", "FSv%", "xFSv%", "Adj.FSv%"), selected = "Sv%")),
                                  column(2, numericInput("n", "Games in average", value = 25, min = 1, max = 50))
                                ),
